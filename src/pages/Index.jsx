...
const Index = () => {
  const product = {
    image: "https://images.unsplash.com/photo-1523275335684-37898b6baf30?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w1MDcxMzJ8MHwxfHNlYXJjaHwxfHxwcm9kdWN0fGVufDB8fHx8MTcxMjM4Mzg4N3ww&ixlib=rb-4.0.3&q=80&w=1080", // This will be replaced with an image URL.
    title: "Modern Chair",
    price: "$299.99",
